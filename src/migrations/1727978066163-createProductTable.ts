...
export class CreateProductTable1727978066163 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_1442fd7cb5e0b32ff5d0b6c13d" ON "product" ("uuid") `,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP INDEX "public"."IDX_1442fd7cb5e0b32ff5d0b6c13d"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_bebc9158e480b949565b4dc7a8"`,
    );
